Shader "Custom/TangoRGBAndLight" {
	Properties
	{
		...
		[MaterialToggle] _RenderVertexColor("RenderVertexColor", Float) = 0
	}
	SubShader{
		...
		uniform float _RenderVertexColor;
